...
$input->SetNotify_url("https://pay.wechat.createcdigital.com/madnessh5160816/wxpay/pub/notify.php");
...
<div class="loader">
    ...
    <h1 class="l-5 in-1" style="color:#fff"></h1>
</div>
<!-- pagelist-->
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide p2">
            ...
            <select class="e2-8 in-1" id="payfor">
                <option value="1">WeChat Pay RSVP:100 RMB</option>
                <option value="2">Online RSVP, Pay Onsite:120 RMB</option>
            </select>
        </div>
